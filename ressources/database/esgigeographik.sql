...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 24 Juillet 2017 à 17:51
...
--
-- Contenu de la table `hbv_categories`
--
...
--
-- Contenu de la table `hbv_comments`
--
...
--
-- Contenu de la table `hbv_messages`
--

INSERT INTO `hbv_messages` (`id`, `content`, `date_inserted`, `date_updated`, `threads_id`, `users_id`, `deleted`) VALUES
(1, 'Paul le popol', '2017-07-22 14:35:16', NULL, 1, 2, 0),
(2, 'un truc vrai', '2017-07-22 16:45:05', NULL, 1, 1, 0),
(3, 'On s\'en bats les couilles', '2017-07-22 16:47:06', NULL, 3, 8, 1),
(4, '<p>test final</p>', '2017-07-22 18:14:38', NULL, 1, 2, 1),
(5, '<p>testfdp</p>', '2017-07-22 18:21:24', NULL, 1, 2, 1);
...
--
-- Contenu de la table `hbv_multimedias`
--
...
--
-- Contenu de la table `hbv_threads`
--
...
--
-- Contenu de la table `hbv_topics`
--
